    ...
    public partial class PlanView : UserControl
    {
        ...
        public PlanView()
        {
            ...
            for (var i = 0; i < viewModel.Kafelki.Count; i++)
            {
                ...
                double windowSize = 3200;
                double minutePixels = windowSize/(60*14);
                double minutesFromSeven = (int.Parse(tempS[0])*60 + int.Parse(tempS[1])) - 7*60;
                tempC = minutePixels * minutesFromSeven - (windowSize - 400);
